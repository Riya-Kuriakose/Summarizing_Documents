...
qa = RetrievalQA.from_chain_type(llm=flan_ul2_llm, chain_type="stuff", retriever=doc_search.as_retriever(), return_source_documents=True)
...
qa = RetrievalQA.from_chain_type(llm=flan_ul2_llm, chain_type="stuff", retriever=doc_search.as_retriever(),chain_type_kwargs=chain_type_kwargs, return_source_documents=True)
print(qa.invoke("Do you think Riya is mad?"))
